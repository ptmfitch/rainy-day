...
const model = new ChatOpenAI({
  ...
  azureOpenAIApiInstanceName:
    process.env.AZURE_OPENAI_API_INSTANCE_NAME_4_0_VISION,
  azureOpenAIApiDeploymentName:
    process.env.AZURE_OPENAI_API_DEPLOYMENT_NAME_4_0_VISION,
  maxTokens: 2500,
});
...
export async function POST(req, res) {
  ...
  try {
    ...
    const prompt = `Describe the contents of the image that isn't attached (use your imaginitive powers). \n`;
