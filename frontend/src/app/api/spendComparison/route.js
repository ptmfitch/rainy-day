...
export async function GET(request) {
  try {
    ...
    )} last month. Give me an insight in the following form [{"title":"Headline","insight":"Humorous insight","detail":"Detailed output including values","category":"OneWordCategory}].  Don't make any of the one word categories generic. \n`;
